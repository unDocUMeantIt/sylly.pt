...
#' 
#' Hyphenation patterns for Portuguese to be used by \code{\link[sylly:hyphen]{hyphen}}.
...
#' \dontrun{
#' library(sylly.pt)
#' sampleText <- c("este","e","um","exemplo","bastante","estupido")
#' hyphen(sampleText, hyph.pattern="pt")
#' }
NULL
